...
set noxtics
set noytics
set title 'DET plot for exp/dnn4_pretrain-dbn_dnn_smbr/decode_dev_it1/score_14/ctm_39phn.filt'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 "exp/dnn4_pretrain-dbn_dnn_smbr/decode_dev_it1/score_14/ctm_39phn.filt.det.dat.00" using 2:1 title "exp/dnn4_pretrain-dbn_dnn_smbr/decode_dev_it1/score_14/ctm_39phn" with lines 1
set ytics
set xtics
set size 1.0, 1.0
set key
